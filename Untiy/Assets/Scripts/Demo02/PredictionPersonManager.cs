...
{
    public class PredictionPersonManager : MonoBehaviour
    {
        // ===================== Config =====================
        ...
        public class PersonSlot
        {
            ...
            [NonSerialized] internal PredictionPersonManager _manager;
        }
        ...
        public class RoomDisplay
        {
            ...
            [NonSerialized] internal PredictionPersonManager _mgr;
        }
